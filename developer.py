...
class Developer:
	def __init__(self, root):
		...
		#Image in top bar
		img_top=Image.open(r"C:\Users\Jagerna Shrestha\OneDrive\Desktop\Face-Recognition-System-main\img\developerImg.jpg")
		...
		img_top1=Image.open(r"C:\Users\Jagerna Shrestha\OneDrive\Desktop\Face-Recognition-System-main\img\devPic.jpg")
		...
		dev_label=Label(main_frame,text="Hello, this is Jagerna and Aryav",font=("times new roman",15,"bold"),bg="white")
		dev_label.place(x=0,y=50)

		dev_label=Label(main_frame,text="We are students",font=("times new roman",15,"bold"),bg="white")
		dev_label.place(x=0,y=100)

		dev_label=Label(main_frame,text="A student of Purbanchal University",font=("times new roman",15,"bold"),bg="white")
